 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  Catcb1_sd.allocate(fmyear,lmyear,"Catcb1_sd");
  Catcb2_sd.allocate(fmyear,lmyear,"Catcb2_sd");
  Catac1_sd.allocate(fmyear,lmyear,"Catac1_sd");
  Catac2_sd.allocate(fmyear,lmyear,"Catac2_sd");
