...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  M_bay.allocate(1,mblock,fage,lage,"M_bay");
  M_ocean.allocate(1,mblock,fage,lage,"M_ocean");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  B.allocate(1,stock,1,region,fmyear,lmyear,"B");
    ...
    B.initialize();
  #endif
  SSB.allocate(1,stock,1,region,fmyear,lmyear,fage,lage,"SSB");
  #ifndef NO_AD_INITIALIZE
    SSB.initialize();
  #endif
  ...
  #endif
  pen_ac_sel.allocate("pen_ac_sel");
  #ifndef NO_AD_INITIALIZE
  pen_ac_sel.initialize();
  #endif
