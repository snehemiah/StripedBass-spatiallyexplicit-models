...
//aging erorr and  logisitc in cb fishery
...
PARAMETER_SECTION
  ...
  matrix ESS_C(1,region,fmyear,lmyear) // ess for catch
  ...
  number pen_feq //penalty for estimating log_feq
  number pen_sf //penalty for descending limb of cb double logistic 50% sel
  number pen_sf_ct//penalty for descending limb of ct double logistic 50% sel
...
FUNCTION evaluate_likelihood
  ...
  */
  ...
  neg_LL=sum(Lcatch)+sum(Lcatchagecomp)+Lindex_md+sum(Lindex_cm)+Lindex_ny+Lindex_nj+sum(Lindex_ct)+Lindex_des+
          ...
          pen_F+pen_prop+pen_prop_aco+pen_prop_bay+pen_cb_sel+pen_rdev+pen_fdev+pen_feq+pen_sf_ct+pen_sf;//sum(Lfsel)+Lssel_md+sum(Lssel_cm)+Lssel_ny+Lssel_nj+sum(Lssel_ct)+Lssel_des+Lssel_de30
    /*
